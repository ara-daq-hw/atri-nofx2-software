...
/* I2C State isn't enough, so just define a status function */
mcp2221_error mcp2221_i2cFullStatus(mcp2221_t* device, mcp2221_i2c_state_t* state, mcp2221_i2c_status_t* status);
